#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=0 python examples/SRLToPB.py --mode LSTM --num_epochs 10 --batch_size 32 --hidden_size 512 \
 ...
 --dev "data/conll2012/english/dev_wtriggers_temp.txt" \
 --test "data/conll2012/english/test_wtriggers_temp.txt" \
 --t_train "PB_data/train_wtriggers.txt" \
 --t_test "PB_data/test_wtriggers.txt" \
 --t_dev "PB_data/train_wtriggers.txt" \
 --result_path "tmp/results_temp.txt"
